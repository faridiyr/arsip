...
class Surat_Keterangan_Ahli_Waris extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/surat_keterangan_ahli_waris', $data);
    ...
    public function tambah_surat()
    {
        ...
        if (($this->form_validation->run() == TRUE) && (!empty($_FILES['file']['name']))) {
            ...
            if ($this->upload->do_upload('file')) {
                ...
                redirect('Surat_Keterangan_Ahli_Waris');
            } else {
    ...
    public function delete_surat()
    {
        ...
        //load data folder
        $data['surat_keterangan_ahli_waris'] = $this->Surat_Keterangan_Ahli_Waris_Model->select_data_surat_byId($id)->row();
        $file = $data['surat_keterangan_ahli_waris']->file;

        //hapus file dari folder
        $filehapus = './assets/upload/surat_keterangan_ahli_waris/' . $file;
        unlink($filehapus);

        //hapus data repositori
        $this->Surat_Keterangan_Ahli_Waris_Model->delete_surat($id);
    }
}
