...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?= site_url('Surat_Keterangan_Nikah') ?>">
            <i class="fas fa-fw fa-house-user"></i>
            <span>Keterangan Nikah</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="<?= site_url('Surat_Keterangan_Usaha') ?>">
            <i class="fas fa-fw fa-store"></i>
            <span>Keterangan Usaha</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="<?= site_url('Surat_Keterangan_Catatan_Kepolisian') ?>">
            <i class="fas fa-fw fa-balance-scale"></i>
            <span>SKCK</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="<?= site_url('Surat_Keterangan_Izin_Kayu') ?>">
            <i class="fas fa-fw fa-tree"></i>
            <span>Keterangan Izin Kayu</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="<?= site_url('Surat_Keterangan_Ahli_Waris') ?>">
            <i class="fas fa-fw fa-boxes"></i>
            <span>Keterangan Ahli Waris</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="<?= site_url('Surat_Keterangan_Kematian') ?>">
            <i class="fas fa-fw fa-bed"></i>
            <span>Keterangan Kematian</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="<?= site_url('Surat_Keterangan_Tidak_Mampu') ?>">
            <i class="fas fa-fw fa-hands-helping"></i>
            <span>Keterangan Tidak Mampu</span></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="<?= site_url('Surat_Keterangan_Lainnya') ?>">
